            ...
            <div className={this.props.className}>    	
                <div className="exchange-bordered buy-sell-container">
                    <div className={"exchange-content-header " + type}>
                        ...
                        {this.props.onFlip ? 
                        	<span onClick={this.props.onFlip} style={{cursor: "pointer", fontSize: "1rem"}}> &#8646;</span> : null}
                        {this.props.onTogglePosition ? 
                        	<span onClick={this.props.onTogglePosition} style={{cursor: "pointer", fontSize: "1rem"}}>&#8645;</span> : null}
                        
                        {/*我的余额*/}
                        <font style={{fontSize:"12px",float:"right"}}>
                        ...
                        <div className="grid-block vertical no-overflow no-padding">
                            ...
                            <div>
                                <div className="grid-content clear-fix no-padding">
                                    ...
                                    {/* BUY/SELL button */}
                                    {disabledText ?
                                        (<div className="float-right btn-buy" data-tip={disabledText} data-place="right">
                                            <input style={{margin: 0}} className={buttonClass} type="submit" onClick={onSubmit.bind(this, true)} value={buttonText} />
                                        </div>) :
                                        (<div className="float-right btn-buy" data-tip={""}>
                                            <input style={{margin: 0}} className={buttonClass} type="submit" onClick={onSubmit.bind(this, true)} value={buttonText} />
                                        </div>)
                                    }
	                            	...
	                            	{disabledText && isPredictionMarket ? (
                                        <div style={{paddingRight: 10}} className="float-right btn-buy" data-tip={disabledText} data-place="right">
                                        ...
                                        <div style={{paddingRight: 10}} className="float-right btn-buy" data-tip={""}>
                                            <input style={{margin: 0}} className={buttonClass} type="submit" onClick={onSubmit.bind(this, false)} value={forceSellText} />
                                        </div>) : null
                                    }
