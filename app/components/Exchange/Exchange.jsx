    ...
    render() {
        ...
        return (
            <div className="grid-block page-layout market-layout">
                    ...
                    <div style={{paddingTop: 0}} className={cnames("grid-block main-content vertical no-overflow")} >
                        ...
                        {!showDepthChart ? (
                            ...
                            <div className="grid-block no-overflow wrap shrink" >
                            	<div style={{position: "absolute",top:"-20px",right:"12px",fontSize:"14px",lineHeight:"0px"}}>手续费:0.10%</div>
                    ...
                    <div className="grid-block shrink right-column no-overflow vertical show-for-medium" style={{paddingTop: 0, minWidth:260, maxWidth:260}}>
                        {/* Market History */}
                        ...
                        <div style={{padding: !this.props.miniDepthChart ? 0 : "0 0 50px 0"}} className="grid-block no-margin vertical shrink">
