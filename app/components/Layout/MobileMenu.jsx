              ...
              <div className="grid-content" style={{zIndex: 200}}>
                ...
                <section style={{marginTop: "3rem"}} className="block-list">
                    <ul>
                        ...
                        <li><a onClick={this._onNavigate.bind(this, "/trade")}>首页</a></li>
                        <li><a onClick={this._onNavigate.bind(this, "/market/BMAN_JRC")}>交易</a></li>
                        <li><a onClick={this._onNavigate.bind(this, "/recharge")}>充值</a></li>
                        <li><a onClick={this._onNavigate.bind(this, "/cash")}>提现</a></li>
